...
@Component({
  selector: 'la-maint-cust-service-query',
  templateUrl:'./maintcustservice.html'
})
export class SysMaintCustServiceQuery implements OnInit {
  ...
  public toView(curId):any {
    this.router.navigate(['/pages/lamaint/sysmaintview'], {queryParams: {paramId: curId,'backAction':'service'}});
  }
