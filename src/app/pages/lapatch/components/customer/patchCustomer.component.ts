...
@Component({
  selector: 'la-patch-customer-query',
  templateUrl:'./patchCustomer.html'
})
export class PatchCustomerQuery implements OnInit {
  ...
  public constructor(fb:FormBuilder, private router:Router,private route:ActivatedRoute, private corpCustomerService:CorpCustomerService,private busiTypeService:BusiTypeService,private modalService: NgbModal, private authService:AuthService) {
  ...
  addCustomer(){
    ...
    customerModal.componentInstance.modalHeader = '选择公司';
