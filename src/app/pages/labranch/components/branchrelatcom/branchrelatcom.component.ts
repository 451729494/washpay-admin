...
@Component({
  selector: 'la-branchrelatcom-query',
  templateUrl:'./branchrelatcom.html'
})
export class BranchBindCom implements OnInit {
  ...
  public toViewCom(curId){
    console.log(curId+"==============")
    this.router.navigate(['/pages/labranch/bindedcommercial'], {queryParams: {paramId: curId}});
    console.log(curId+"--------------");
  }
