...
@Component({
  selector: 'la-orderreport-view',
  templateUrl: './orderreportView.html'
})
export class OrderreportView implements OnInit{
  ...
  public constructor(fb:FormBuilder,private acRoute:ActivatedRoute,private router: Router,private orderreportService:OrderreportService) {
