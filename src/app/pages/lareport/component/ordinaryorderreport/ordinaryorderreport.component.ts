...
@Component({
  selector: 'la-ordinaryorderreport-query',
  templateUrl:'./ordinaryorderreport.html'
})
export class OrdinaryOrderreportQuery implements OnInit {
  ...
  public loadData() {
    ...
    this.orderreportService.pageQueryByOrdinary(requestParam)
      .subscribe(res => {
        if (res.successed === '00') {
          this.rows = res.data;
