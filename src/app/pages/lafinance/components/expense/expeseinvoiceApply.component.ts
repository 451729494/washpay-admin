...
@Component({
  selector: 'la-express-invoice-apply',
  templateUrl:'./expeseinvoiceApply.html'
})
export class CorpExpeseInvoiceApply implements OnInit {
  ...
  public toApproved(curId) {
    ...
    this.corpExpeseInvoiceService.toApprove(JSON.stringify(params))
      .subscribe(res => {
        if (res.successed === '00') {
          this.loadData();
        }
