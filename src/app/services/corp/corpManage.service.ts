...
export class CorpManageService {
  ...
  public delete(params:any):Observable<any>{
    return this.http.post(Keys.SERVER_URL + '/secure/corpManage/delete','', {search:params, headers:this._authService.getHeadersAuth()})
      .map(res => res.json());
  }


  public updateStatus(params:any):Observable<any>{
    return this.http.post(Keys.SERVER_URL + '/secure/corpManage/updateStatus','', {search:params, headers:this._authService.getHeadersAuth()})
      .map(res => res.json());
  }
}
